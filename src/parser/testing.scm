...
(define test11
  (let (
        ...
        (test11_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test12
  (let (
        ...
        (test12_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (Term Atom lparen (TermList (Term Num)) rparen)) comma (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term Atom)) rparen)) comma (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Atom lparen (TermList (Term Atom lparen (TermList (Term Atom lparen (TermList (Term Atom lparen (TermList (Term Atom)) rparen)) rparen)) rparen)) rparen)) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test18
  (let (
        ...
        (test18_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (Term (LTerm lsqbrack (TermList (TermList (Term Var)) comma (Term Var)) rsqbrack))) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test19
  (let (
        ...
        (test19_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (Term (LTerm lsqbrack (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rsqbrack))) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test22
  (let (
        ...
        (test22_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (Term (LTerm lsqbrack (TermList (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term (LTerm lsqbrack (TermList (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rsqbrack))) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term (LTerm lsqbrack (TermList (Term (LTerm lsqbrack (TermList (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rsqbrack))) rsqbrack))) rsqbrack))) rsqbrack))) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test23
  (let (
        ...
        (test23_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (Term (LTerm lsqbrack rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (TermList (Term Var)) comma (Term Var)) vertline (Term Var) rsqbrack))) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test24
  (let (
        ...
        (test24_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (Term (LTerm lsqbrack (TermList (TermList (TermList (TermList (Term Atom)) comma (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) vertline (Term Atom lparen (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) rsqbrack))) rparen) fullstop) (RuleList)) EndMarker))
       )
...
(define test27
  (let (
        ...
        (test27_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom)) comma (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) comma (Term Atom lparen (TermList (Term Var)) rparen)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList))) EndMarker))
       )
...
(define test28
  (let (
        ...
        (test28_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var)) comma (ABody (SBody (Term Var)))) semicolon (OBody (ABody (SBody (Term Var)) comma (ABody (SBody (Term Var)))) semicolon (OBody (ABody (SBody (Term Var)) comma (ABody (SBody (Term Var)))) semicolon (OBody (ABody (SBody (Term Var)) comma (ABody (SBody (Term Var)))))))) fullstop) (RuleList)) EndMarker))
       )
...
(define test29
  (let (
        ...
        (test29_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term Var))) semicolon (OBody (ABody (SBody (Term Var) equals (Term Var))) semicolon (OBody (ABody (SBody (Term Var) equals (Term Var))) semicolon (OBody (ABody (SBody (Term Var) equals (Term Var))))))) fullstop) (RuleList)) EndMarker))
       )
...
(define test30
  (let (
        ...
        (test30_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var)) comma (ABody (SBody lparen (OBody (ABody (SBody (Term Var))) semicolon (OBody (ABody (SBody (Term Var))))) rparen) comma (ABody (SBody lparen (OBody (ABody (SBody (Term Var))) semicolon (OBody (ABody (SBody (Term Var))))) rparen) comma (ABody (SBody lparen (OBody (ABody (SBody (Term Var))) semicolon (OBody (ABody (SBody (Term Var))))) rparen) comma (ABody (SBody (Term Var)))))))) fullstop) (RuleList)) EndMarker))
       )
...
(define test31
  (let (
        ...
        (test31_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody (Term Var) equals (Term Var)))) semicolon (OBody (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody (Term Var) equals (Term Var)))))) fullstop) (RuleList)) EndMarker))
       )
...
(define test32
  (let (
        ...
        (test32_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (TermList (TermList (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody lparen (OBody (ABody (SBody (Term Var) equals (Term Var))) semicolon (OBody (ABody (SBody (Term Var) equals (Term Var))))) rparen) comma (ABody (SBody (Term Var) equals (Term Var)))))) fullstop) (RuleList)) EndMarker))
       )
...
(define test33
  (let (
        ...
        (test33_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack))) comma (ABody (SBody (Term Var) equals (Term Var))))) rparen)) semicolon (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack))) comma (ABody (SBody (Term Var) equals (Term Var))))) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) rparen) colon-minus (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen)))))) rparen)) semicolon (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) comma (Term Var)) rparen)))))) rparen)))) fullstop) (RuleList))) EndMarker))
       )
...
(define test98
  (let (
        ...
        (test98_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen)) comma (ABody (SBody exclam) comma (ABody (SBody (Term Atom)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack))) comma (ABody (SBody (Term Var) equals (Term Var))))) rparen)) semicolon (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack))) comma (ABody (SBody (Term Var) equals (Term Var))))) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) rparen) colon-minus (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen)))))) rparen)) semicolon (OBody (ABody (SBody lparen (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Var) equals (Term Var)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) comma (Term Var)) rparen)))))) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack rsqbrack))) comma (Term (LTerm lsqbrack rsqbrack))) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack)))) semicolon (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term (LTerm lsqbrack (TermList (TermList (Term Var)) comma (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (TermList (Term Var)) comma (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack)))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Atom lparen (TermList (Term Var)) rparen)) rparen)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack)))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen)))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term (LTerm lsqbrack rsqbrack)))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen)))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom)) comma (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Var) equals (Term Var))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Atom)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody exclam)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term Num)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Num)) rparen)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term Atom)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))) semicolon (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList)))))))))))))))))))))))))))))))))))))))))))))) EndMarker))
       )
...
(define test99
  (let (
        ...
        (test99_output '(Prog (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen)) comma (ABody (SBody exclam) comma (ABody (SBody (Term Atom)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack rsqbrack))) comma (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack rsqbrack))) comma (Term (LTerm lsqbrack rsqbrack))) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term (LTerm lsqbrack rsqbrack))) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term (LTerm lsqbrack (TermList (TermList (Term Var)) comma (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term (LTerm lsqbrack (TermList (TermList (Term Var)) comma (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Atom lparen (TermList (Term Var)) rparen)) rparen)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term (LTerm lsqbrack rsqbrack))) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom)) comma (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Atom lparen (TermList (Term Var)) rparen)) comma (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Atom)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term (LTerm lsqbrack rsqbrack))) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term (LTerm lsqbrack (TermList (Term Var)) vertline (Term Var) rsqbrack))) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody exclam)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term Num)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Num)) rparen)) rparen))))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom)) comma (Term Atom)) rparen) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)) comma (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList (Rule (Term Atom lparen (TermList (TermList (Term Atom lparen (TermList (TermList (TermList (Term Var)) comma (Term Var)) comma (Term Var)) rparen)) comma (Term Var)) rparen) colon-minus (OBody (ABody (SBody (Term Atom lparen (TermList (TermList (Term Var)) comma (Term Var)) rparen)))) fullstop) (RuleList))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) EndMarker))
       )
